...
class ShiftCollectionViewCell: UICollectionViewCell {
    static let identifier = "ShiftCollectionViewCell"
    ...
    override var isSelected: Bool {
        willSet{
            ...
            if newValue {
                ...
                self.shiftLabel.textColor = UIColor.white
            } else {
                self.contentView.layer.borderWidth = 0.0
                self.contentView.layer.cornerRadius = 5.0
                self.contentView.backgroundColor = Constants.vcBackgroundColor
                self.shiftLabel.textColor = UIColor.black
            }
        }
    }
    ...
    override func layoutSubviews() {
        ...
        shiftLabel.frame = contentView.bounds
    }
