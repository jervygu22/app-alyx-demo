...
////}
//
//class OLDOptionsViewController: UIViewController, FloatingPanelControllerDelegate, AddOnsViewControllerDelegate {
//
...
//
//    private let addOnsFPC = FloatingPanelController()
//
...
//
//        addOnsButton.addTarget(self, action: #selector(didTapAddOn), for: .touchUpInside)
//
//        updateUI(with: product)
//
//        addOnsFPC.delegate = self
//        addOnsFPC.isRemovalInteractionEnabled = true
//        addOnsFPC.contentMode = .fitToBounds
//
//        layoutFloatingPanel()
//
////        guard let floatingPanelVC = storyboard?.instantiateViewController(withIdentifier: "") as? AddOnsViewController else {
////            return
////        }
//
////        let tapToHideAddOns = UITapGestureRecognizer(target: self, action: #selector(didTapToHideAddOns))
////        self.view.addGestureRecognizer(tapToHideAddOns)
//        showAddOnsButton()
//
//        isDeviceAuthorized()
//
...
//    }
//
//    func addOnsAdded(addOnsSelected: [AddOnsData]) {
//        addOnsChosed = addOnsSelected
//        addOnsPriceSum = 0
//
...
//            print("currentProductSubtotal: \(currentProductSubtotal)")
//            DispatchQueue.main.async {
//                self.priceLabel.text = String(format:"₱%.2f", Double(currentProductSubtotal + self.addOnsPriceSum))
//            }
//        }
//
//    }
...
////        if addOns.contains(where: { $0.finished_product_id == product.product_id }) {
...
//        appearance.backgroundColor = Constants.whiteBackgroundColor//.clear
//
//        // Set the new appearance
//        addOnsFPC.surfaceView.appearance = appearance
//    }
//
...
//    }
//
//    @objc func didTapAddOn() {
//        print("didTapAddOn")
//
//        let cartLastAdded = cartEntity.filter({ $0.cart_status == "added" })
//        let cart_last_order_id = cartLastOrderEntity.last?.cart_last_order_id ?? 1000000000
//        let orderID = !cartLastAdded.isEmpty ? cart_last_order_id : cart_last_order_id + 1
//
//        let floatingPanelVC = AddOnsViewController(
//            product: self.product,
//            addOns: addOns,
//            orderID: orderID,
//            cartEntity: cartLastAdded)
//        floatingPanelVC.addOnsViewControllerDelegate = self
//        addOnsFPC.addPanel(toParent: self)
//        addOnsFPC.set(contentViewController: floatingPanelVC)
//
//
////        self.present(floatingPanelVC, animated: true, completion: nil)
//
//    }
//
...
//        let filteringTotalPrice = qtyStepper.value * (filteringProductCost ?? product.price)
...
//    }
//
//    @objc private func didTapToHideAddOns() {
//        print("didTapToHideAddOns")
//        // Inform the panel controller that it will be removed from the hierarchy.
//        addOnsFPC.willMove(toParent: nil)
//        // Hide the floating panel.
//        addOnsFPC.hide(animated: true, completion: {
//            // Remove the floating panel view from your controller's view.
//            self.addOnsFPC.view.removeFromSuperview()
//            // Remove the floating panel controller from the controller hierarchy.
//            self.addOnsFPC.removeFromParent()
//        })
//    }
//
//    func shouldCloseFloatingPanel() {
//        print("shouldCloseFloatingPanel")
//        // Inform the panel controller that it will be removed from the hierarchy.
//        addOnsFPC.willMove(toParent: nil)
//        // Hide the floating panel.
//        addOnsFPC.hide(animated: true, completion: {
...
//                    ProductOption(title: $0.option)
//            }))
//        }) ?? prodAttribs
//
//        let addOnsData = ProductOptionSection(title: "Add Ons", options: addOns.compactMap({ addOn in
//            ProductOption(title: addOn.name)
//        }))
//
//
//        print("prodVariations: ", prodVariations)
...
//                return ProductOption(title: $0.title)
//            }))
//        })))
//
...
////                    return ProductOption(title: $0.name)
////                }))
////        ))
//
//    }
...
//
//extension OLDOptionsViewController: UICollectionViewDelegate, UICollectionViewDataSource {
...
//        cell.configure(withModel: OptionsCollectionViewCellViewModel(id: 1, data: model.title))
//        return cell
//    }
//
...
//
//
//extension OLDOptionsViewController {
