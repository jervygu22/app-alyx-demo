...
// MARK: - UpdateCouponDataModel
struct UpdateCouponDataModel: Codable {
    let discount_name: String
    let product_ids: [Int]
}


// MARK: - UpdateCouponProductResponse
struct UpdateCouponProductResponse: Codable {
    let id: Int
    let code, amount, status, dateCreated: String
    let dateCreatedGmt, dateModified, dateModifiedGmt, discountType: String
    let updateCouponProductResponseDescription: String
    let dateExpires, dateExpiresGmt: JSONNull?
    let usageCount: Int
    let individualUse: Bool
    let productIDS, excludedProductIDS: [JSONAny]
    let usageLimit, usageLimitPerUser, limitUsageToXItems: JSONNull?
    let freeShipping: Bool
    let productCategories, excludedProductCategories: [JSONAny]
    let excludeSaleItems: Bool
    let minimumAmount, maximumAmount: String
    let emailRestrictions, usedBy, metaData: [JSONAny]
    let links: Links

    enum CodingKeys: String, CodingKey {
        case id, code, amount, status
        case dateCreated = "date_created"
        case dateCreatedGmt = "date_created_gmt"
        case dateModified = "date_modified"
        case dateModifiedGmt = "date_modified_gmt"
        case discountType = "discount_type"
        case updateCouponProductResponseDescription = "description"
